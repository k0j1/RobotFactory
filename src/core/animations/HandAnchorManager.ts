...
const STORAGE_KEY = 'robot_arm_joint_anchor_configs_v2';
const LEGACY_STORAGE_KEY = 'robot_hand_anchor_configs_v1';
...
export const AVAILABLE_ARM_PARTS: ArmPartOption[] = [
  // ★1 (Common) - 8種類
  { key: 'arm_r1_v0', name: '★1 ベーシックアーム (#0)', rarity: 1, visualIndex: 0 },
  { key: 'arm_r1_v1', name: '★1 ラウンドアーム (#1)', rarity: 1, visualIndex: 1 },
  { key: 'arm_r1_v2', name: '★1 ヘビーアーム (#2)', rarity: 1, visualIndex: 2 },
  { key: 'arm_r1_v3', name: '★1 クローアーム (#3)', rarity: 1, visualIndex: 3 },
  { key: 'arm_r1_v4', name: '★1 レンチアーム (#4)', rarity: 1, visualIndex: 4 },
  { key: 'arm_r1_v5', name: '★1 キャノンアーム (#5)', rarity: 1, visualIndex: 5 },
  { key: 'arm_r1_v6', name: '★1 ブレードアーム (#6)', rarity: 1, visualIndex: 6 },
  { key: 'arm_r1_v7', name: '★1 シールドアーム (#7)', rarity: 1, visualIndex: 7 },
  // ★2 (Uncommon/Rare) - 4種類
  { key: 'arm_r2_v0', name: '★2 ナックルアーム (#0)', rarity: 2, visualIndex: 0 },
  { key: 'arm_r2_v1', name: '★2 サイバーアーム (#1)', rarity: 2, visualIndex: 1 },
  { key: 'arm_r2_v2', name: '★2 ヘビーアーム (#2)', rarity: 2, visualIndex: 2 },
  { key: 'arm_r2_v3', name: '★2 バスターアーム (#3)', rarity: 2, visualIndex: 3 },
];

// デフォルトの肩・拳座標（パーツ別プリセット）
const DEFAULT_ARM_JOINT_CONFIGS: ArmHandConfigMap = {
  'arm_r1_v0': {
    partKey: 'arm_r1_v0',
    partName: '★1 ベーシックアーム (#0)',
  ...
  'arm_r1_v1': {
    partKey: 'arm_r1_v1',
    partName: '★1 ラウンドアーム (#1)',
    rightShoulder: { x: 75.0, y: 46.0 },
    leftShoulder: { x: 25.0, y: 46.0 },
    rightHand: { x: 75.0, y: 61.5 },
    leftHand: { x: 25.0, y: 61.5 },
  },
  'arm_r1_v2': {
    partKey: 'arm_r1_v2',
    partName: '★1 ヘビーアーム (#2)',
    rightShoulder: { x: 75.0, y: 46.0 },
    leftShoulder: { x: 25.0, y: 46.0 },
    rightHand: { x: 77.0, y: 63.0 },
    leftHand: { x: 23.0, y: 63.0 },
  },
  'arm_r1_v3': {
    partKey: 'arm_r1_v3',
    partName: '★1 クローアーム (#3)',
    rightShoulder: { x: 75.0, y: 46.0 },
    leftShoulder: { x: 25.0, y: 46.0 },
    rightHand: { x: 76.5, y: 62.5 },
    leftHand: { x: 23.5, y: 62.5 },
  },
  'arm_r1_v4': {
    partKey: 'arm_r1_v4',
    partName: '★1 レンチアーム (#4)',
  ...
  'arm_r1_v6': {
    partKey: 'arm_r1_v6',
    partName: '★1 ブレードアーム (#6)',
    rightShoulder: { x: 75.0, y: 46.0 },
    leftShoulder: { x: 25.0, y: 46.0 },
    rightHand: { x: 77.5, y: 63.0 },
    leftHand: { x: 22.5, y: 63.0 },
  },
  'arm_r1_v7': {
    partKey: 'arm_r1_v7',
    partName: '★1 シールドアーム (#7)',
    rightShoulder: { x: 75.0, y: 46.0 },
    leftShoulder: { x: 25.0, y: 46.0 },
    rightHand: { x: 76.5, y: 62.5 },
    leftHand: { x: 23.5, y: 62.5 },
  ...
  'arm_r2_v1': {
    partKey: 'arm_r2_v1',
    partName: '★2 サイバーアーム (#1)',
    rightShoulder: { x: 75.5, y: 46.5 },
    leftShoulder: { x: 24.5, y: 46.5 },
    rightHand: { x: 78.0, y: 63.5 },
    leftHand: { x: 22.0, y: 63.5 },
  },
  'arm_r2_v2': {
    partKey: 'arm_r2_v2',
    partName: '★2 ヘビーアーム (#2)',
