  ...
  return (
    <div className="space-y-6 pb-12">
      ...
      <Card className="bg-stone-50 border-2 border-stone-200">
        <h3 className={`${theme.typography.h3} mb-4 text-stone-700`}>ポンコツロボット工房 v1.0.119 仕様まとめ</h3>
        ...
        <div className="space-y-6 text-sm text-stone-800">
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-1 ml-2">
              ...
              <li><strong>自動探索（放置探索）:</strong> ロボットを自動探索へ派遣（余計な確認ダイアログなしでスムーズに出撃）しておくと、1周期毎にHPを1消費しながら定期的に素材を自動発見・蓄積します（工房画面から随時回収可能）。残りHPが1以下になる直前で自動的に探索を中断し帰還待機状態になります。</li>
