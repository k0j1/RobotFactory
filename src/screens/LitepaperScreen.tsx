  ...
  return (
    <div className="space-y-6 pb-12">
      ...
      <Card className="bg-stone-50 border-2 border-stone-200">
        <h3 className={`${theme.typography.h3} mb-4 text-stone-700`}>ポンコツロボット工房 v1.0.132 仕様まとめ</h3>
        ...
        <div className="space-y-6 text-sm text-stone-800">
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-1 ml-2">
              ...
              <li><strong>ステータス・レーダーチャート可視化:</strong> ロボット選択時に「📊 レーダー」ボタンをタップすることで、耐久力(HP)・攻撃力(Power)・防御力(Defense)・速度(Agility)・探索力(Dexterity)・解析力(Intelligence)の6角形レーダーチャートを展開。機体の特徴が一目で把握できます。</li>
