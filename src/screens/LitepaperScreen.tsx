  ...
  return (
    <div className="space-y-6 pb-12">
      ...
      <Card className="bg-stone-50 border-2 border-stone-200">
        <h3 className={`${theme.typography.h3} mb-4 text-stone-700`}>ポンコツロボット工房 v1.0.85 仕様まとめ</h3>
        ...
        <div className="space-y-6 text-sm text-stone-800">
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-1 ml-2">
              ...
              <li><strong>素材商店・交換所（専用フィーチャーカード）:</strong> 工房画面上で目立つ専用カードとして配置され、所持Gや所持キット数をリアルタイム表示。Gを使って素材を購入したり、特定の素材を消費して「工房の背景（内装）」を獲得・変更できます。また、<strong>「修理キット交換」</strong>機能により、余った素材（★1素材:3個→1個、★2素材:1個→1個、★3素材:1個→3個）を消費してロボットの体力回復用【修理キット】と交換できます。</li>
