  ...
  return (
    <div className="space-y-6 pb-12">
      ...
      <Card className="bg-stone-50 border-2 border-stone-200">
        <h3 className={`${theme.typography.h3} mb-4 text-stone-700`}>ポンコツロボット工房 v1.0.205 仕様まとめ</h3>
        ...
        <div className="space-y-6 text-sm text-stone-800">
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-1 ml-2">
              ...
              <li><strong>拡大・縮小ズームスライダー機能（ロボット完成画面・組立プレビュー・動作テスト完了時）:</strong> ロボット合成画面において、完成後のロボットプレビュー（およびパーツ選択中のアセンブリプレビュー、接合・動作テスト完了時）に拡大・縮小ズームスライダーを導入しました。60%〜220%の連続倍率スライダー、拡大（+）/ 縮小（-）ボタン、100%ワンタップリセット、および「70% 全体」「100% 標準」「140% 詳細」「200% 最大」のクイックプリセットボタンにより、完成した機体の頭部・胸部コア装甲・腕部ナックル・脚部シリンダーなどの精緻なディテールや接続バランスを自由自在に拡大・縮小してじっくり鑑賞・点検できます。</li>
            </ul>
          </section>
