  ...
  return (
    <div className="space-y-6 pb-12">
      ...
      <Card className="bg-stone-50 border-2 border-stone-200">
        <h3 className={`${theme.typography.h3} mb-4 text-stone-700`}>ポンコツロボット工房 v1.0.191 仕様まとめ</h3>
        ...
        <div className="space-y-6 text-sm text-stone-800">
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-1 ml-2">
              ...
              <li><strong>図鑑・仕様書（パーツ図鑑 &amp; 素材別出現一覧 &amp; 納品履歴）:</strong> 商店カードと分離し、上部のコンパクトな情報ナビゲーションとして配置。これまでに納品したロボットの履歴、獲得G推計のほか、新設された<strong>「パーツ図鑑」タブ</strong>にてヘッド・ボディ・アーム・レッグの全パーツ形状を部位別・レア度（★1〜★3）別にギャラリー形式で一覧確認可能になりました。新たに追加された☆2ランクボディ（ハイテクコアボディ、バイザーコアボディ）および<strong>☆2ランクレッグ（サイバーレッグ）</strong>などの高精細パーツも属性カラーを切り替えながら確認できます。また、パーツの部位呼称は「アーム」「レッグ」に統一されました。</li>
            </ul>
          </section>
