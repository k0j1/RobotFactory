              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs">
                ...
                <div className="bg-white p-3 rounded-lg border border-stone-200 space-y-1.5">
                  ...
                  <ul className="list-disc list-inside space-y-1 text-stone-600">
                    ...
                    <li><strong>Googleアカウント連携 &amp; クラウドデータ同期:</strong> Googleアカウントでログインした場合、オンライン上にゲームデータ（工房ステータス、所持機体、パーツ、遠征、ミニゲーム成績等）が自動的に保存・同期されます。所持パーツテーブル（<code>user_parts</code>）はJSON集約から各パラメータ（vitality・power・defense・agility・dexterity・intelligence・attribute・rarity・勝率等）の個別カラムへ構造化され、データベースレベルでの精密・高速な能力値集計と完全な整合性が保証されます。別の端末からでも同じアカウントで続きからプレイが可能です。ゲストプレイ時は端末内に独立してデータが保護されます。</li>
