  ...
  return (
    <div className="space-y-6 pb-12">
      ...
      <Card className="bg-stone-50 border-2 border-stone-200">
        <h3 className={`${theme.typography.h3} mb-4 text-stone-700`}>ポンコツロボット工房 v1.0.221 仕様まとめ</h3>
        
        <div className="space-y-6 text-sm text-stone-800">
          <section>
            <h4 className="font-bold text-stone-900 border-b border-stone-300 pb-1 mb-2">演習・ミニゲーム (v1.0.221 拠点防衛戦・1日1回防衛成功制限＆毎朝9:00デイリーリセット対応)</h4>
            <ul className="list-disc list-inside space-y-2">
              <li><strong>拠点防衛戦 (1日1回成功限定 &amp; 毎朝09:00デイリーリセット):</strong>
                <ul className="list-disc list-inside space-y-1 ml-4 mt-1">
                  ...
                  <li><strong>毎朝 09:00 デイリーリセット:</strong> 毎日午前09:00（朝9時）を迎えると防衛任務が自動リセットされ、再び出撃可能となります。リセットまでの残り時間（時間・分）は画面上でリアルタイムにカウントダウン表示されます。</li>
