  ...
  return (
    <div className="space-y-6 pb-12">
      ...
      <Card className="bg-stone-50 border-2 border-stone-200">
        <h3 className={`${theme.typography.h3} mb-4 text-stone-700`}>ポンコツロボット工房 v1.0.130 仕様まとめ</h3>
        ...
        <div className="space-y-6 text-sm text-stone-800">
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-1 ml-2">
              ...
              <li><strong>クラフト（工場UI）:</strong> 画面全体をロボット工場（プラント）風のダークテーマ・金属質デザインに刷新。パーツの部位別製造状況を1行の横スクロールバーでコンパクトかつ直感的に把握できるよう改善しました。また素材選択時には、背景色とラベルだけでなく、**アイコン自体の色も属性色**になり、属性が視覚的にわかりやすくなりました。</li>
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-1 ml-2">
              ...
              <li><strong>ガレージ風UIへの刷新:</strong> 工房（ダッシュボード）、遠征、製造の各画面において、以前のサイバー調（ネオンやレーダーUI）から、ハンマーや歯車が転がる**「ガレージ・工場風」**の錆びた金属・警戒色（アンバー）を基調としたインダストリアルデザインに完全移行しました。</li>
