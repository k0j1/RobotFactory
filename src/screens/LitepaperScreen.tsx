  ...
  return (
    <div className="space-y-6 pb-12">
      ...
      <Card className="bg-stone-50 border-2 border-stone-200">
        <h3 className={`${theme.typography.h3} mb-4 text-stone-700`}>ポンコツロボット工房 v1.0.152 仕様まとめ</h3>
        ...
        <div className="space-y-6 text-sm text-stone-800">
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-1 ml-2">
              <li><strong>ガレージアンビエンス演出（金属製シェルフ・工具箱・ペグボード＆炎アニメーション削除）:</strong> 工房背景にガレージらしさを強める装飾UIを追加。左側に4段の金属製スチールシェルフ（パーツ缶、スプレー、オイル缶、ポータブル工具箱、パーツキャビネット）、右側に有孔ペグボード（工具壁掛け：レンチ、ハンマー、ペンチ、定規）と引き出し付きスチールツールチェスト、中央にバイス付きワークベンチを配置。また、視認性を高め落ち着きを保つため不要な炎のアニメーションを削除し、背景に溶け込む上品な透過度（opacity 0.30前後）で全体の配置バランスを整えました。</li>
